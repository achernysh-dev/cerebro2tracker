# -*- coding: utf-8 -*-
"""
The sample shows the usage of PyQt6 package (http://www.riverbankcomputing.com/software/pyqt/).
...
def create_menu():	
	...
	my_menu.add_action('twin_plugin.examples.pyqt.show_dialog',  'Qt dialog') # adding the menu item
	my_menu.add_action('twin_plugin.examples.pyqt.show_window',  'Qt window') # adding the menu item
