...
TASK_FLAG_CLOSED					= 2		# !obsolette задача закрыта
TASK_FLAG_ARCHIVED					= 2		# задача в архиве
TASK_FLAG_TASK_AS_EVENT				= 3		# задача помечена как событие
TASK_FLAG_SUSPENED					= 4		# !obsolette задача остановлена (на паузе)
TASK_FLAG_HAS_OWN_THUMB				= 4		# задача имеет собственный тамбнейл
TASK_FLAG_FORUM_LOCKED				= 5		# форум задачи залочен
TASK_FLAG_CLOSED_EFFECTIVE			= 30	# !obsolette задача закрыта, поскольку закрыта задача более верхнего уровня
TASK_FLAG_SUSPENED_EFFECTIVE		= 31	# !obsolette задача остановлена, поскольку остановлена задача более верхнего уровня
...
COPY_TASKS_SUBSCRIBE_USERS_FULL		= 1024	# уведомить назначенных подписчиков
COPY_TASKS_SUBSCRIPTION				= 2048	# копировать подписчиков
COPY_TASKS_STATUS_AND_PROGRESS		= 4096	# копировать статус и прогресс
...
If :py:const:'STATUS_FLAG_WORK_STARTED <pycerebro.dbtypes.STATUS_FLAG_WORK_STARTED>` and :py:const:'STATUS_FLAG_WORK_STOPPED <pycerebro.dbtypes.STATUS_FLAG_WORK_STOPPED>` flags are reseted,
then the type of status will mean that the task is suspended.
"""

TAG_DATA_ = ''
"""
.. rubric:: Tag tuple fields
"""
TAG_DATA_MTM			= 0
"""
Time of data change.
...
User.
"""
TAG_TYPE_MULTI_USER		= 6
"""
Multiple users. A tag of this type may contain several user ids.
"""
...
"""
Tag value. Type - string. In case of multiple values, the latter are separated by semicolons.
"""
...
Universe ID.
"""
CHECK_DATA_CREATED			= 2
"""
Check created at.
"""
CHECK_DATA_CREATOR_ID		= 3
"""
Check created by.
"""
CHECK_DATA_MTM				= 4
...
TASK_CHECK_DATA_ = ''
"""
.. rubric:: Tuple fields of check set on a task
"""
TASK_CHECK_DATA_MTM				= 0
"""
Task check modified at.
"""
TASK_CHECK_DATA_MODERATOR_ID	= 1
"""
Task check modified by.
"""
TASK_CHECK_DATA_TASK_ID			= 2
"""
Task ID.
"""
TASK_CHECK_DATA_CHECK_ID		= 3
"""
Check ID.
"""
TASK_CHECK_DATA_FLAGS			= 4
"""
Check flags in task checklist.
"""
TASK_CHECK_DATA_VALUE			= 5
"""
Check value in task checklist.
"""
TASK_CHECK_DATA_ORDER			= 6
"""
Check order in task checklist.
"""
